...
export function ItemsView({source, onClose}: Props) {
    ...
    const displaySource = source === '__all' ? undefined : source === '__meetings' ? undefined : source
    ...
    const title = source === '__all' ? 'All Items' : source === '__meetings' ? 'Today\'s Meetings' : source
        ...
        <div className="flex flex-col h-full">
            ...
            {items.length} items
                ...
                <div className="flex items-center gap-2">
                    ...
                    <button onClick={load} className="p-1.5 rounded hover:bg-accent transition-colors" title="Refresh">
            ...
            <div className="flex-1 overflow-y-auto scrollbar-thin p-4">
                ...
                {error && (
                    <div
                        className="rounded-lg border border-red-200 bg-red-50 dark:border-red-800 dark:bg-red-900/20 p-3 text-sm text-red-700 dark:text-red-300">
                        {error}
                    </div>
                )}
                                            ...
                                            <div className="flex-1 min-w-0">
                                                ...
                                                <div
                                                    ...
                                                    {item.source !== source && source === '__all' && (
                                                        <span
                                                            className="px-1.5 py-0.5 rounded bg-muted text-[10px]">{item.source}</span>
                                                    )}
