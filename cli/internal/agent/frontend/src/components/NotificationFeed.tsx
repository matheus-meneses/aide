...
function PermissionBanner({permission, onEnable}: {
...
export function NotificationFeed({events, onEventClick, onDismiss, notificationPermission, onEnableNotifications}: Props) {
    ...
    useEffect(() => {
        ...
        return () => { feedOpenRef.current = false }
    }, [])
    ...
    const handleDismiss = (event: AgentEvent) => {
        ...
        setAckError('')
        onDismiss?.(event)
        ackAlert(fp, title || body).catch(err => {
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="flex items-center gap-1 shrink-0">
                                ...
                                <button
                                    onClick={(e) => { e.stopPropagation(); handleDismiss(event) }}
